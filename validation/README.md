...
to this field. This can be done by using the method ```addFieldRule(fieldName, fieldValue, rules)```.
This method accept three parameters, the first is the name of the field we want to validate. The second parameter is the value of the field under validation, and the third is all rules this field
value must pass.
